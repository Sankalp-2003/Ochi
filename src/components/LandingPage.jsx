...
function LandingPage() {
  return (
    <div
      data-scroll
      data-scroll-speed="-.8"
      className="lp w-full h-screen pt-1"
    >
      <div className="textStructure mt-40 md:px-20">
        <div className="sticker absolute right-0">
            ...
            <div className=" w-fit flex items-center">
              {index === 1 && (
                <motion.div
                  ...
                  className="w-[8vw] h-[5vw]  rounded-md overflow-hidden mr-2"
                >
                  <img
              ...
              <h1 className="uppercase text-[8vw] md:text-[6.5vw] font-['Poppins'] md:leading-[6vw] tracking-tighter font-medium ">
                {item}
              </h1>
            </div>
          </div>
      ...
      <div className="border-t-2 border-zinc-800 mt-32 md:flex  justify-between items-center md:py-5 md:px-20 lp-text">
        {[
