...
function Footer() {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed="-.3"
      className="footer flex gap-5 w-full h-screen bg-zinc-900 p-20 "
    >
      <div className="w-1/2  h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[7vw] font-semibold uppercase leading-none -mb-4 ">
            Eye-
          </h1>
          <h1 className="text-[7vw] font-semibold uppercase leading-none -mb-4 ">
            opening
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] tracking-tighter font-semibold uppercase leading-none -mb-4 ">
          presentations
        </h1>
        <div className="links  h-[30vw] flex flex-col flex-wrap items-center justify-between ">
          <div>
            <p className="mb-5 mt-10">S:</p>
