    ...
    <div className="eyes w-full h-screen overflow-hidden">
      ...
      >
        <div className="absolute flex gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]">
          <div className=" flex items-center justify-center w-[15vw] h-[15vw] rounded-full bg-zinc-100 eye-white">
            <div className="relative  w-[8.5vw] h-[8.5vw] rounded-full bg-zinc-900 eye-black">
              <div
                style={{
